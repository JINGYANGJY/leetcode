...
public class isRectangleOverlap {
    ...
    public boolean isRectangleOverlap(int[] rec1, int[] rec2) {
        return !(rec1[2] <= rec2[0] ||   // rec1 is on the left of rec2
                rec1[3] <= rec2[1] ||   // rec1 is on the bottom of rec2
                rec1[0] >= rec2[2] ||   // rec1 is on the right of rec2
                rec1[1] >= rec2[3]);    // rec1 is on the top of rec2
    }
}
